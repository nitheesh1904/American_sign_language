...
from ml_model.model import PointHistoryClassifier
...
def main():
    ...
    with open(
            'ml_model/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
...
def logging_csv(number, mode, landmark_list, point_history_list):
    ...
    if mode == 2 and (0 <= number <= 9):
        csv_path = 'ml_model/model/point_history_classifier/point_history.csv'
        with open(csv_path, 'a', newline="") as f:
            writer = csv.writer(f)
